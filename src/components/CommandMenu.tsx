        ...
        <div className="space-y-4 max-h-96 overflow-y-auto pr-1">
          ...
          <div>
            ...
            <div className="space-y-1">
              {[
                { id: 'briefing', label: 'Executive Briefing & Evaluation Paths', icon: Zap },
                { id: 'metrics', label: 'Observability & SLA Turnaround Grid', icon: FileText },
                { id: 'studio', label: 'Live AI Transformation Studio (Presets & Diff)', icon: Sparkles },
                { id: 'exemplars', label: "Ope's 50+ Exemplar Bank & 5 Laws", icon: Database },
                { id: 'evaluator', label: 'SDR Hiring Manager 6-Second Glance Rubric', icon: UserCheck },
                { id: 'roi', label: 'Coaching ROI & Economics Calculator', icon: Calculator },
                { id: 'blueprints', label: 'Zero Lock-In Architectural Blueprints', icon: Download },
              ].map((item) => {
          ...
          <div className="border-t border-[var(--color-border)] pt-3">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <span>Launch Chaos & Dual-Provider Failover Test</span>
              </button>
              ...
              >
                ...
                <span>View Securiti AI LLM Firewall & PII Sanitizer</span>
              </button>
              ...
              >
                ...
                <span>Open Live LLM Latency & Token Stream</span>
              </button>
            </div>
          </div>
        </div>
